...
export const hostProfileWorkspaces: WorkspaceDescriptor[] = [
  {
    ...
    icon: 'DM',
    allowedEditorKinds: ['welcome', 'settings', 'table-demo', 'graph-placeholder', 'inspector-demo', 'external-mount-demo', 'view-tree', 'view-inspector', 'view-2d', 'view-table'],
    recommendedEditorKinds: ['welcome', 'table-demo', 'graph-placeholder', 'external-mount-demo', 'view-tree', 'view-2d'],
