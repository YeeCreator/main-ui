...
安装 `main-ui` 后，可在包目录的 `docs/` 中直接查看以下文档：

- [USER_MANUAL.md](USER_MANUAL.md)：用户手册与基本使用。
...
- [MIGRATION_GUIDE_0.2.0.md](MIGRATION_GUIDE_0.2.0.md)：从 0.1.1 升级到 0.2.0（monorepo 结构变更、Slot/占位/溢出收纳增强，API 只增不改）。
...
- [HOST_PROFILE_VALIDATION.md](HOST_PROFILE_VALIDATION.md)：宿主 profile 验证说明。
- [RELEASE_ARCHIVE.md](RELEASE_ARCHIVE.md)：旧版本文档与发布包归档说明。

完整开发记录见 [DEVELOPMENT_LOG.md](DEVELOPMENT_LOG.md)。
